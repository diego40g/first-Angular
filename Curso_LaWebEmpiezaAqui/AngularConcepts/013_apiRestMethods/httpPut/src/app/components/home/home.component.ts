...
export class HomeComponent {
  ...
  updateArticleDetail(article: Article) {
    article.title = 'Este es un titulo editado';
    article.body = 'Este es el cuerpo editado';

    this.InjectArticle.updateArticle(article).subscribe((articleReceived) => {
